        ...
        DB::statement('
            CREATE VIEW product_variation_stock_view AS
                SELECT
                    ...
                    COALESCE(SUM(stocks.quantity), 0) - COALESCE(SUM(order_product_variation.quantity), 0) AS stock,
                    CASE WHEN COALESCE(SUM(stocks.quantity), 0) - COALESCE(SUM(order_product_variation.quantity), 0)
                        THEN 1
                        ELSE 0
                    END in_stock
